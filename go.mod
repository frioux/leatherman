...
require (
	...
	github.com/frioux/yaml v2.1.0+incompatible // indirect
	...
	github.com/icza/mighty v0.0.0-20180222163138-6304d21ca645 // indirect
	github.com/jeffjen/datefmt v0.0.0-20180806102909-4cdce70efce1
